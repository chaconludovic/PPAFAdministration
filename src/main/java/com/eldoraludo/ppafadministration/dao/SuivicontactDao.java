...
/**
 * JPA 2 Data Access Object for {@link com.eldoraludo.ppafadministration.domain.Suivicontact}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class SuivicontactDao extends GenericDao<Suivicontact, Integer> {
    public SuivicontactDao() {
        super(Suivicontact.class);
    }
}