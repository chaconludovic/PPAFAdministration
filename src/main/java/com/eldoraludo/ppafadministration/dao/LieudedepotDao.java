...
import com.eldoraludo.ppafadministration.dao.LieudedepotDao;
...
/**
 * JPA 2 Data Access Object for {@link com.eldoraludo.ppafadministration.domain.Lieudedepot}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class LieudedepotDao extends GenericDao<Lieudedepot, Integer> {
    public LieudedepotDao() {
        super(Lieudedepot.class);
    }
}