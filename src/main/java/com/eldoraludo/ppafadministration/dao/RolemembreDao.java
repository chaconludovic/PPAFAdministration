...
/**
 * JPA 2 Data Access Object for {@link com.eldoraludo.ppafadministration.domain.Rolemembre}.
 * Note: do not use @Transactional in the DAO layer.
 */
@Named
@Singleton
public class RolemembreDao extends GenericDao<Rolemembre, Integer> {
    public RolemembreDao() {
        super(Rolemembre.class);
    }
}