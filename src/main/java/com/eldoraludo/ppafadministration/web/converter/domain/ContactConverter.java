...
/**
 * Responsible for creating Contact JSF converters.
 ...
 */
@Component
public class ContactConverter extends GenericJsfConverter<Contact, Integer> {
    @Inject
    public ContactConverter(ContactRepository contactRepository) {
        super(contactRepository, Integer.class);
    }

    @Override
    public String print(Contact contact) {
        return contact == null ? "" : "" + contact.getNom() + "/" + contact.getPrenom() + "/" + contact.getEmail();
    }
}