...
/**
 * Responsible for creating Suividulieudedepot JSF converters.
 ...
 */
@Component
public class SuividulieudedepotConverter extends GenericJsfConverter<Suividulieudedepot, Integer> {
    @Inject
    public SuividulieudedepotConverter(SuividulieudedepotRepository suividulieudedepotRepository) {
        super(suividulieudedepotRepository, Integer.class);
    }

    @Override
    public String print(Suividulieudedepot suividulieudedepot) {
        return suividulieudedepot == null ? "" : "" + suividulieudedepot.getNote();
    }
}